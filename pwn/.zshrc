...
alias pwninit='pwninit --template-path /root/.config/pwn_template.py; libcname=$(ls libc*) && python3 -c "from pwnlib.libcdb import unstrip_libc; unstrip_libc('\''$libcname'\'')"'
